...
const GENDERCHOICES = ['Male', 'Female', 'I prefer not to answer',];
const RACECHOICES = [
    'White',
...
const LANGUAGEPREFERENCECHOICES = ['English', 'Spanish'];
const ETHNICITYCHOICES = ['Hispanic or Latino', 'Not Hispanic or Latino', 'I prefer not to answer'];
...
let OptAddressPipe = class OptAddressPipe {
    transform(address) {
        let newAddress = "";
        if (address != null) {
            if (address[0] != null) {
...
let OptDatePipe = class OptDatePipe {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var ngx_mask__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ngx-mask */ "./node_modules/ngx-mask/fesm2015/ngx-mask.js");



let OptPhonePipe = class OptPhonePipe {
...
let OptSsnPipe = class OptSsnPipe {
    transform(ssn) {
        let newSSN = "";
        if (ssn != null) {
            if (ssn.length == 9) {
...
let EditClaimantAddressComponent = class EditClaimantAddressComponent {
...
let EditClaimantDetailsComponent = class EditClaimantDetailsComponent {
    constructor(activeModal, claimantService, portalService, fb) {
        this.activeModal = activeModal;
        this.claimantService = claimantService;
        this.portalService = portalService;
...
let OptLibraryComponent = class OptLibraryComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var ngx_valdemort__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ngx-valdemort */ "./node_modules/ngx-valdemort/fesm2015/ngx-valdemort.js");
/* harmony import */ var _node_modules_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../node_modules/@ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm2015/ng-bootstrap.js");
...
let OptLibraryModule = class OptLibraryModule {
};
...
let OptLibraryService = class OptLibraryService {
    constructor() { }
};
...
let ClaimantService = class ClaimantService {
    ...
    getAllClaimants() {
        ...
        return this.http.get(claimantUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])((err) => {
    ...
    updateClaimant(id, updateClaimantSO) {
        ...
        return this.http.put(claimantUrl, updateClaimantSO).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])((err) => {
...
let SurveyService = class SurveyService {
    ...
    deleteResponse(claimantId) {
        const claimantUrl = `${this.url}surveyResponse/deleteResponse/${claimantId}`;
        return this.httpClient.delete(claimantUrl).subscribe(() => console.log("Old responses deleted"));
    }
};
...
/* harmony import */ var _node_modules_keycloak_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../node_modules/keycloak-angular */ "./node_modules/keycloak-angular/fesm2015/keycloak-angular.js");
...
/* harmony import */ var ngx_valdemort__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ngx-valdemort */ "./node_modules/ngx-valdemort/fesm2015/ngx-valdemort.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            keycloak_angular__WEBPACK_IMPORTED_MODULE_30__["KeycloakAngularModule"],
            ...
            angular2_moment__WEBPACK_IMPORTED_MODULE_16__["MomentModule"]
        ],
        entryComponents: [],
        providers: [
            {
                provide: _angular_core__WEBPACK_IMPORTED_MODULE_2__["APP_INITIALIZER"],
                useFactory: _app_init__WEBPACK_IMPORTED_MODULE_31__["initializer"],
                multi: true,
                deps: [keycloak_angular__WEBPACK_IMPORTED_MODULE_30__["KeycloakService"]]
            },
...
let ClaimComponent = class ClaimComponent {
    //-------------------------------- CONSTRUCTOR ---------------------------------
    constructor(route, surveyService, toasterService, alert, router) {
        this.route = route;
    ...
    //RENDER A SURVEY
    showSurveyWithResponses(surveyDefinition) {
    ...
    storeResponseAndSend(surveyData) {
...
/* harmony import */ var _claimant_search_service_claimant_search_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../claimant-search-service/claimant-search.service */ "./src/app/main/claimant-search-service/claimant-search.service.ts");
...
let ClaimantOverviewComponent = class ClaimantOverviewComponent {
    constructor(route, claimantService, claimantUsed, searchService) {
        this.route = route;
        this.claimantService = claimantService;
...
ClaimantOverviewComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
        ...
        _claimant_search_service_claimant_search_service__WEBPACK_IMPORTED_MODULE_5__["ClaimantSearchService"]])
...
let ClaimantProfileComponent = class ClaimantProfileComponent {
    constructor(route, modalService, claimantUsed, formBuilder) {
        this.route = route;
        this.modalService = modalService;
        this.claimantUsed = claimantUsed;
    ...
    openEditClaimantDetails(object) {
    ...
    openEditClaimantAddresses(object) {
...
let ClaimantRegistrationComponent = class ClaimantRegistrationComponent {
    constructor(fb, claimantService, toasterService, router) {
        this.fb = fb;
        this.claimantService = claimantService;
        this.toasterService = toasterService;
        this.router = router;
    ...
    onSubmit() {
        this.claimantService
            .registerClaimant(this.userProfileModel).subscribe(data => {
...
/***/ "./src/app/main/claimant-search-service/claimant-search.service.ts":
/*!*************************************************************************!*\
  !*** ./src/app/main/claimant-search-service/claimant-search.service.ts ***!
  \*************************************************************************/
/*! exports provided: ClaimantSearchService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ClaimantSearchService", function() { return ClaimantSearchService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
...
let ClaimantSearchService = class ClaimantSearchService {
    constructor(http) {
        this.http = http;
    ...
    searchClaimant(claimantInfo) {
        ...
        return this.http.post(claimantUrl, claimant);
    }
};
ClaimantSearchService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
], ClaimantSearchService);
...
/* harmony import */ var _claimant_search_service_claimant_search_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../claimant-search-service/claimant-search.service */ "./src/app/main/claimant-search-service/claimant-search.service.ts");
...
let ClaimantSearchComponent = class ClaimantSearchComponent {
    constructor(claimantService, route, toasterService, alert, router, keycloakService, searchService) {
        this.claimantService = claimantService;
        this.route = route;
        this.toasterService = toasterService;
        this.alert = alert;
...
ClaimantSearchComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [projects_opt_library_src_portal_services_claimant_service__WEBPACK_IMPORTED_MODULE_3__["ClaimantService"],
        ...
        _claimant_search_service_claimant_search_service__WEBPACK_IMPORTED_MODULE_7__["ClaimantSearchService"]])
