import { ɵɵdefineInjectable, Injectable, Component, defineInjectable, Directive, Inject, forwardRef, Optional, Host, Input, ContentChildren, Output, ChangeDetectionStrategy, ViewEncapsulation, Renderer2, ElementRef, ChangeDetectorRef, PLATFORM_ID, NgZone, LOCALE_ID, inject, ViewChild, ViewContainerRef, ComponentFactoryResolver, ContentChild, TemplateRef, Injector, ApplicationRef, RendererFactory2, INJECTOR, InjectionToken, EventEmitter, NgModule, ɵɵinject, Pipe } from '@angular/core';
