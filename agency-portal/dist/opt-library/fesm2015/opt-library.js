import { Injectable, ɵɵdefineInjectable, Component, defineInjectable, Directive, Inject, forwardRef, Optional, Host, Input, ContentChildren, Output, ChangeDetectionStrategy, ViewEncapsulation, Renderer2, ElementRef, ChangeDetectorRef, PLATFORM_ID, NgZone, LOCALE_ID, inject, ViewChild, ViewContainerRef, ComponentFactoryResolver, ContentChild, TemplateRef, Injector, ApplicationRef, RendererFactory2, INJECTOR, InjectionToken, EventEmitter, NgModule, ɵɵinject } from '@angular/core';
import { ValdemortModule } from 'ngx-valdemort';
import { isPlatformBrowser, getLocaleDayNames, FormStyle, TranslationWidth, getLocaleMonthNames, formatDate, DOCUMENT, CommonModule } from '@angular/common';
...
export { OptLibraryComponent, OptLibraryModule, OptLibraryService, EditClaimantDetailsComponent as ɵa, ClaimantService as ɵb, ToasterService as ɵc, PortalService as ɵd, EditClaimantAddressComponent as ɵe, NgbModule as ɵf };
