import { Injectable, ɵɵdefineInjectable, Component, defineInjectable, Directive, Inject, forwardRef, Optional, Host, Input, ContentChildren, Output, ChangeDetectionStrategy, ViewEncapsulation, Renderer2, ElementRef, ChangeDetectorRef, PLATFORM_ID, NgZone, LOCALE_ID, inject, ViewChild, ViewContainerRef, ComponentFactoryResolver, ContentChild, TemplateRef, Injector, ApplicationRef, RendererFactory2, INJECTOR, InjectionToken, EventEmitter, NgModule, ɵɵinject, Pipe } from '@angular/core';
import { ValdemortModule } from 'ngx-valdemort';
import { isPlatformBrowser, getLocaleDayNames, FormStyle, TranslationWidth, getLocaleMonthNames, formatDate, DOCUMENT, CommonModule, DatePipe } from '@angular/common';
import { NG_VALUE_ACCESSOR, NG_VALIDATORS, FormsModule, FormBuilder, Validators, ReactiveFormsModule } from '@angular/forms';
import { timer, merge, fromEvent, Subject, race, Observable, BehaviorSubject, EMPTY } from 'rxjs';
import { map, filter, switchMap, takeUntil, take, tap, withLatestFrom, delay, share, catchError } from 'rxjs/operators';
import { __extends, __assign, __read, __values } from 'tslib';
import { NgbActiveModal as NgbActiveModal$1 } from '@ng-bootstrap/ng-bootstrap';
...
/** @nocollapse */
OptLibraryService.ctorParameters = () => [];
/** @nocollapse */ OptLibraryService.ngInjectableDef = ɵɵdefineInjectable({ factory: function OptLibraryService_Factory() { return new OptLibraryService(); }, token: OptLibraryService, providedIn: "root" });

/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class OptLibraryComponent {
    constructor() { }
    /**
     * @return {?}
     */
...
/** @nocollapse */
OptLibraryComponent.ctorParameters = () => [];
...
/** @nocollapse */ ToasterService.ngInjectableDef = ɵɵdefineInjectable({ factory: function ToasterService_Factory() { return new ToasterService(ɵɵinject(ToastrService)); }, token: ToasterService, providedIn: "root" });
...
/** @nocollapse */ ClaimantService.ngInjectableDef = ɵɵdefineInjectable({ factory: function ClaimantService_Factory() { return new ClaimantService(ɵɵinject(HttpClient), ɵɵinject(ToasterService)); }, token: ClaimantService, providedIn: "root" });
...
/** @nocollapse */ PortalService.ngInjectableDef = ɵɵdefineInjectable({ factory: function PortalService_Factory() { return new PortalService(); }, token: PortalService, providedIn: "root" });

/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class EditClaimantAddressComponent {
    /**
     * @param {?} activeModal
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class EditClaimantDetailsComponent {
    /**
     * @param {?} activeModal
     * @param {?} claimantService
     * @param {?} portalService
...
export { OptLibraryComponent, OptLibraryModule, OptLibraryService, EditClaimantDetailsComponent as ɵa, ClaimantService as ɵb, ToasterService as ɵc, PortalService as ɵd, EditClaimantAddressComponent as ɵe, OptSsnPipe as ɵf, OptPhonePipe as ɵg, OptAddressPipe as ɵh, OptDatePipe as ɵi, NgbModule as ɵj };
//# sourceMappingURL=opt-library.js.map
