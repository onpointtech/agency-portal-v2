    ...
    ***************************************************************************** */
    ...
    var ClaimantService = /** @class */ (function () {
        ...
        function (claimantSO) {
            ...
            return this.http.post(claimantUrl, claimantSO).pipe(operators.catchError((/**
             * @param {?} err
             * @return {?}
             */
            function (err) {
    ...
    var EditClaimantDetailsComponent = /** @class */ (function () {
        ...
        function () {
            ...
            this.profileForm = this.fb.group({
                ...
                middleInitial: [null, forms.Validators.minLength(1)],
                homePhone: [null, forms.Validators.minLength(1)],
                mobilePhone: [null],
